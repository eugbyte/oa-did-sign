...
it("should sign a hex string correctly", async () => {
  expect(
    await sign(
      "0xcce7bd33bd80b746b71e943e23ddc88fcb99c9011becdd1b4d8b7ab9567d2adb",
...
it("should sign a string literal correctly", async () => {
  expect(
    await sign("foobar", "0x497c85ed89f1874ba37532d1e33519aba15bd533cdcb90774cc497bfe3cde655", { signAsString: true })
  ).toBe(
